...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        MvcResult result = mvc.perform(get(new URI("/cars"))
                ...
                .andReturn();
        String fetchedString = result.getResponse().getContentAsString();

        assertTrue(fetchedString.contains(car.getDetails().getModel()));
    }
    ...
    public void findCar() throws Exception {
        ...
        assertEquals(car.getDetails().getModel(), fetchedCar.getDetails().getModel());
    }
